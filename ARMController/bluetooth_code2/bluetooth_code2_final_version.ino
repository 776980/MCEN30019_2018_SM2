...
//ASSUMING INDEX MIDDLE TO BE ANTI-CLOCKWISE REPLACE CODE IF IT IS NOT WITH RING PINKY
//So INDEX MIDDLE servo.write stuff goes to RING PINKY servo.write and vice versa
//************************************************************************************
